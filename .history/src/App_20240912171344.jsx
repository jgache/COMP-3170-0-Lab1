      ...
      <div>
        ...
        <div>
          ...
          <details name="reqs">
            ...
            <ol>
              "<li>Your Body's Callin'</li>", "<li>Bump n' Grind</li>", "
              <li>Homie Lover Friend</li>", "<li>It Seems Like You're Ready</li>
              ", "<li>Freak Dat Body</li>", "<li>I Like the Crotch on You</li>",
              "<li>Summer Bunnies</li>", "<li>For You</li>", "
              <li>Back to the Hood of Things</li>", "<li>Sadie</li>", "
              <li>Sex Me, Pt. 1</li>", "<li>Sex Me, Pt. 2</li>", "
              <li>12 Play</li>"
            </ol>
          </details>
        </div>
